...
class DoorSwitch(BaseModule):
    ...
    def on_request(self, event_id, target):
        return self.send_rf24_packet(1, self.unit_no, bytes(event_id + bytes([target, 3, 0x00, 0x10])))  # TODO: send trigger period
    ...
    def web_gui_generate(self, conn_handler, username):
        ...
        return conn_handler.render_string('DoorSwitch.html',
                                          uuid=str(self.uuid),
